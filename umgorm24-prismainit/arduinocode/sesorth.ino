...
const char* serverUrl = "http://192.168.224.48:3002/datos"; // Cambia 'tu_servidor' por la dirección IP o dominio de tu servidor
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (receivedChar == 'v' || receivedChar == 'V') {
      ...
      doc["nombre"] = "Nombre Apellido";
      doc["correo"] = "jgonzalest@miumg.edu.gt";
      doc["carne"] = "18685";
      doc["Latitud"] = "11.123";
      doc["Longitud"] = "-74.123";
      doc["Humedad"] = humedad;
